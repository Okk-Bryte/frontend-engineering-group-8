...
const Footer = () => {
  return (
    <footer className="my-footer">
      ...
      <p className="my-footer-names">Kosisochukwu, Seanam, Ifeoluwa, Kelvin, Chukwunonso</p>
      ...
      <div className="my-footer-bottom">
        ...
        <a href="https://tsacademyonline.com/" target="_blank" rel="noreferrer" className="my-footer-ts-link">TSAcademy</a>
      </div>
    </footer>
  );
};
